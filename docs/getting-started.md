...
Sign up at [app0.resolve.ai](http://app0.resolve.ai), authorize access via OAuth, and you're in. The whole process is designed to be seamless.

<p align="center">
  <img src="https://raw.githubusercontent.com/krovvidiv-code/image-storage/main/docs/images/image13.png" width="500" alt="Sign up flow">
</p>
...
When you first log in, you'll be presented with two primary ways to explore Resolve AI.
  ...
  <tbody>
    <tr>
      <td rowspan="2" align="center">
        <img src="https://raw.githubusercontent.com/krovvidiv-code/image-storage/main/docs/images/image6.png" alt="Login options" width="100%">
      </td>
      <td>
        <strong>Explore Resolve AI in our playground.</strong><br>
        Dive into a simulated environment that mirrors the complexity of real production systems: microservices, message queues, caches, databases, and intermittent failures.
      </td>
    </tr>
    <tr>
      <td>
        <strong>Set up Resolve AI for your environment.</strong><br>
        Connect your observability stack, infrastructure, code repositories, and team knowledge to use Resolve AI with your own production systems.
      </td>
    </tr>
  </tbody>
</table>
...
> [!TIP]
> We recommend starting with the **Playground**. It lets you build intuition for Resolve AI's capabilities without any setup. You can switch to your own organizational environment at any time via **Change Orgs → Playground** in the menu.
...
> [!NOTE]
> ### How it works:
> - **Operates Your Tools:** Connects across your stack to query data or take actions like updating tickets and generating PRs.
> - **Synthesizes Expertise:** Plans investigations like a senior engineer, coordinating multiple agents to build causal timelines.
> - **Evolves with You:** Learns from your runbooks, past incidents, and tribal knowledge, getting smarter with every interaction.
...
[**Next: Explore the Playground →**](quickstart-playground.md)
